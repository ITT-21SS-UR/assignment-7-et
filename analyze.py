...
class LogNode(Node):
    ...
    def __init__(self, name):
        ...
        Node.__init__(self, name, terminals=terminals)
        # sys.stdout.write('Values - Accel X: ' + ['accelX'])
    ...
    def process(self, **kargs):
        ...
        # sys.stdout.write(x_text, x, y_text, y, z_text, z, end)
        # sys.stdout.flush()
        log = 'Hallo'
        return {'log': log}
...
def create_flowchart():
    ...
    # fc.connectTerminals(log_node['log'],fc['out'])

    # sys.stdout.write(log_node.output())
    # sys.stdout.flush()
